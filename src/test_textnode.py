...
from split_node import extract_markdown_images, extract_markdown_links, split_nodes_delimiter
...
class TestTextNode(unittest.TestCase):
    ...
    def test_not_eq_different_types(self):
        # Test that nodes with different text_types are not equal
        node = TextNode("This is a text node", TextType.BOLD)
    ...
    def test_not_eq_different_url(self):
        ...
        node2 = TextNode("This is a text node", TextType.LINK, "https://examples.com")
    def test_text(self):
